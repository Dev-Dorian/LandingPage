    ...
    <section className='wrapper text-center py-24 grid gap-12 md:grid-cols-2 md:text-left'>
      ...
      <div className='grid gap-12'>
        ...
        <article className='space-y-4 md:space-y-6'>
          ...
          <p className='text-dark-grayish-blue text-left'>Set internal delivery estimates and track progress toward company goals. Our customisable dashboard helps you build out the reports you need to keep key stakeholders informed.</p>
        </article>
        <article className='space-y-4 md:space-y-6'>
          <p className='bg-very-pale-red rounded-l-full font-bold flex items-center md:bg-transparent'>
          ...
          <p className='text-dark-grayish-blue text-left'>Stop jumping from one service to another to communicate, store files, track tasks and share documents. Manage offers an all-in-one team productivity solution.</p>
        </article>
      </div>      
    </section>
  )
